...
import ImageHeroFrame from 'assets/images/hero-image-frame.jpg';
        ...
        <div className='row align-items-center'>
            ...
            <div className='col-6 pl-5'>
                <div style={{width: 540, height: 410}}>
                    <img src={ImageHero} className='img-fluid position-absolute' alt='Room with couches' style={{margin: '-30px 0 0 -30px', zIndex: 1}}/>
                    <img src={ImageHeroFrame} className='img-fluid position-absolute' alt='Room with couches frame' style={{margin: '0 -15px -15px'}}/>
                </div>
            </div>
        </div>
    </section>
